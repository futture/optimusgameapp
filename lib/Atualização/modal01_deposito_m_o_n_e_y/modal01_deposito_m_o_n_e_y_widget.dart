...
import 'modal01_deposito_m_o_n_e_y_model.dart';
export 'modal01_deposito_m_o_n_e_y_model.dart';

class Modal01DepositoMONEYWidget extends StatefulWidget {
  const Modal01DepositoMONEYWidget({super.key});

  @override
  State<Modal01DepositoMONEYWidget> createState() =>
      _Modal01DepositoMONEYWidgetState();
}

class _Modal01DepositoMONEYWidgetState
    extends State<Modal01DepositoMONEYWidget> {
  late Modal01DepositoMONEYModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modal01DepositoMONEYModel());
